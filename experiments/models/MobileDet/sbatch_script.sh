#!/bin/sh
#SBATCH --job-name=MobileDet_olym_home            # Job name
...
#SBATCH --output=multi_LRU_output.txt        # Standard output and error log
...
cd ../../../../
singularity exec smaug_latest.sif "`pwd`/smaug/experiments/models/MobileDet/trace_script.sh"
