...
${gem5_dir}/build/X86/gem5.opt \
  ...
  --outdir=${cfg_home}/outputs_acp_nocache \
  ...
  --accel_cfg_file=gem5_acp.cfg \
  --fast-forward=10000000000 \
  -c ${bmk_dir}/smaug \
  -o "minerva_smv_topo_acp.pbtxt minerva_smv_params.pb  --gem5 --iterations=10 --debug-level=0 --num-accels=1" \
  #> stdout 2> stderr
