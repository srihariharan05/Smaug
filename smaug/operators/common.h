...
extern long int stat_num_of_tiles;
...
typedef fp_t v256fp_t
        __attribute__((__vector_size__(VECTOR_SIZE * 32 * sizeof(fp_t))));
/** 16 packed 32-bit floating point values. */
typedef fp_t v32fp_t
        __attribute__((__vector_size__(VECTOR_SIZE * 4 * sizeof(fp_t))));
/** 16 packed 32-bit floating point values. */
typedef fp_t v16fp_t
