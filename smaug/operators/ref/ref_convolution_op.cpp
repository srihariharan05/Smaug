...
void ref_conv3d_nchw_valid_padding(float* input,
    ...
    printf(" inside conv_nchw_valid_padding_kernel \n");
...
void ConvolutionOp<ReferenceBackend>::run() {
    ...
    dout(0) << " convolution kernel running \n";
